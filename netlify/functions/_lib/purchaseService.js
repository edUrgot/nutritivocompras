...
export async function savePurchaseFlow(repository, rawBody) {
    ...
    const documentNumber = payload.header.documentNumber.trim() || (await repository.getNextDocumentNumber(payload.header.purchaseDate)).documentNumber;
